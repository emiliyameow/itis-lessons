...
Работа .Net заключается в объединении кодов, написанных на разных языках программирования (C#, Visual Basic, F#, C++ и т.д.), в один байт-код, который затем компилируется в нативный код.